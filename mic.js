...
function warningError(message, line=-1){
    let log_message = "Warning" + (line < 0 ? ": " : (" at line " + line +" :"));
...
class Register{
    ...
    set value(number){
        ...
        if(number >= this.size){
            warningError(ERROR_registerOverflow + "; masking number");
            number = number & this._mask;
        }
...
class MIC_seq_logic{
    ...
    doNextSubcycle(){
        console.log("Doing subcycle " + this._current_subcycle);
        switch(this._current_subcycle){
            case 0:
                this.subcycle1();
                break;
            case 1:
...
let tmp_arr = [
    ...
    0b00000000010100000110000000000000,
    0b10110000000100110000000000011100,
    0b00100100000101000011001100010011,
    0b00100100000101000000010000001011,
    0b00110000000000000000010000001001,
    0b00000000110000000011000000000000,
    0b00000000010000000000000000000000,
    0b11110000000100010000000000000000,
    0b00010001101000000011000100000000,
    0b01100000001000000000000000000000,
    0b00110000000000000000010000001111,
    0b00000000110000000011000000000000,
    0b00000000010000000000000000000000,
    0b11100000000100010001000000000000,
    0b00000000110000000011000000000000,
    0b00000000010100010110000100000000,
    0b10011000000110100000000000000000,
    0b01100000000100011010000100000000,
    0b00100100000101000000010000011001,
    0b00110000000000000000010000010111,
    0b00110000000000000000000100000000,
    0b01101000000100001000001100000000,
    0b01010000000000000000000100010110,
    0b01100000000000000000000000000000,
    0b00110000000000000000010000011011,
    0b01101000000100001000001100000000,
    0b01101000000100011000001100000000,
    0b00100100000101000011001100101000,
    0b00100100000101000000010000100011,
    0b00110000000000000000010000100001,
    0b00000000000110100010001100000000,
    0b01100000110000001010000000000111,
    0b00000000000110100010001100000000,
    0b01110001101000001010000100001010,
    0b00110000000000000000010000100110,
    0b00000000000110100010001100000000,
    0b01100000110000001010000000001101,
    0b00000000000110100010001100000000,
    0b01100000110000001010000000010000,
    0b00100100000101000000010000101110,
    0b01000000000000000100010000101100,
    0b00110000000000000000000100010110,
    0b01100000000000000000000000000000,
    0b01010000000000000000000100000000,
    0b01101000000100001000001100000000,
    0b00100100000101000000010000110010,
    0b00000000000100100111001000000000,
    0b00010001101000000010000000000000,
    0b01101000001100001000001100000000,
    0b00100100000101000000010001000001,
    0b00100100000101000000010000111011,
    0b00110000000000000000010000111000,
    0b00000000110000000001000000000000,
    0b00000000010100100111001000000000,
    0b01100000101000000010000000001010,
    0b00000000110100100010011000000000,
    0b00000000010000000000000000000000,
    0b01100000101000000001000000001010,
    0b00110000000000000000010000111110,
    0b00000000000100100111001000000000,
    0b01110001101000000010000100001010,
    0b00000000110100100010011000000000,
    0b00000000010000000000000000000000,
    0b11110000000100010000000000000000,
    0b00100100000101000000010001001001,
    0b00110000000000000000010001000110,
    0b00000000110100100010011000000000,
    0b00000000010000000000000000000000,
    0b11110000000100000000000000000000,
    0b00010000000110100000000100000000,
    0b00010000000100010000001000000000,
    0b01110000000100100000101000000000,
    0b00100100000101000000010001001100,
    0b00001000000110101001001100000000,
    0b01100000000100101010001000000000,
    0b00110000000000000000010001010000,
    0b00001000000110101001001100000000,
    0b00011000000110100000101000000000,
    0b01100000000110100110101001001011,
    0b11111111111111111111111111111111,
    0b00010000000110100000011000000000,
    0b11111111111111111111111111111111    
];

for(let i = 0; i < tmp_arr.length; i++){
    logic.program_memory[i] = tmp_arr[i];
}


document.getElementById("nextSubcycle").onclick = () => {logic.doNextSubcycle();};

// logic.program_memory.forEach(x => {
//     if(x != 0){
//         logic.doFullCycle();
//     }
// });
